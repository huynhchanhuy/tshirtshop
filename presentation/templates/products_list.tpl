    ...
    <table class="product-list" border="0">
        <tbody>
            {section name=k loop=$obj->mProducts}
                {* The purpose is displaying the product table in 2 columns *}
                {* If this is the even index, it will be the beginning column (0,2,4,6 ...) *}
                ...
                {* Check the second columns and it's not the first columns or it will be the last columns *}
